...
#python spider.py -k 森林火灾 -f ./source/fire/
#python spider.py -k 绿色森林 -f ./source/forest/
#python spider.py -k 晚霞 -f ./source/cloud/
...
add_arg('--keyword', '-k', default='', help='输入要查询的关键词')
add_arg('--download_page', '-dp', default=10, type=int, help='希望下载的页数，每页60张图')
add_arg('--dir','-f', default='./download_pic/', help='下载图片保存的位置')
...
for dp in xrange(start_page,start_page+download_page):
